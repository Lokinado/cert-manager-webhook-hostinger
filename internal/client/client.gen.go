...
const (
	Import ReachV1ContactsContactResourceSource = "import"
	Manual ReachV1ContactsContactResourceSource = "manual"
	Sync   ReachV1ContactsContactResourceSource = "sync"
)
...
const (
	Created VPSV1DockerManagerProjectResourceState = "created"
	Mixed   VPSV1DockerManagerProjectResourceState = "mixed"
	Running VPSV1DockerManagerProjectResourceState = "running"
	Stopped VPSV1DockerManagerProjectResourceState = "stopped"
	Unknown VPSV1DockerManagerProjectResourceState = "unknown"
)
...
const (
	Subscribed   ReachListContactsV1ParamsSubscriptionStatus = "subscribed"
	Unsubscribed ReachListContactsV1ParamsSubscriptionStatus = "unsubscribed"
)
...
type BillingV1CatalogCatalogItemResource struct {
	...
	// Metadata Flexible key-value storage containing category-specific metadata for the catalog item. The structure and available fields vary depending on the item category.
...
type ReachV1ContactsContactResource struct {
	...
	Source             *ReachV1ContactsContactResourceSource             `json:"source"`
...
type ReachV1ContactsStoreRequest struct {
	...
	GroupUuids *[]openapi_types.UUID `json:"group_uuids"`
	Name       *string               `json:"name"`
	Note       *string               `json:"note"`
...
type VPSV1DockerManagerContainerPortResource struct {
	...
	ContainerPortEnd *int `json:"container_port_end"`

	// ContainerPortStart Starting port number in container port range (null for single ports)
	ContainerPortStart *int `json:"container_port_start"`
...
type VPSV1DockerManagerContainerResource struct {
	...
	Stats *VPSV1DockerManagerContainerResource_Stats `json:"stats"`
...
type VPSV1VirtualMachineRecreateRequest struct {
	// PanelPassword Panel password for the panel-based OS template. If not provided, random password will be generated. If OS does not support panel_password this field will be ignored. Password will not be shown in the response.
...
// BillingCreateServiceOrderV1JSONRequestBody defines body for BillingCreateServiceOrderV1 for application/json ContentType.
type BillingCreateServiceOrderV1JSONRequestBody = BillingV1OrderStoreRequest
...
type ClientInterface interface {
	...
	// BillingCreateServiceOrderV1WithBody request with any body
	BillingCreateServiceOrderV1WithBody(ctx context.Context, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*http.Response, error)

	BillingCreateServiceOrderV1(ctx context.Context, body BillingCreateServiceOrderV1JSONRequestBody, reqEditors ...RequestEditorFn) (*http.Response, error)
...
func (c *Client) BillingCreateServiceOrderV1WithBody(ctx context.Context, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewBillingCreateServiceOrderV1RequestWithBody(c.Server, contentType, body)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
func (c *Client) BillingCreateServiceOrderV1(ctx context.Context, body BillingCreateServiceOrderV1JSONRequestBody, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewBillingCreateServiceOrderV1Request(c.Server, body)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
// NewBillingCreateServiceOrderV1Request calls the generic BillingCreateServiceOrderV1 builder with application/json body
func NewBillingCreateServiceOrderV1Request(server string, body BillingCreateServiceOrderV1JSONRequestBody) (*http.Request, error) {
	...
	return NewBillingCreateServiceOrderV1RequestWithBody(server, "application/json", bodyReader)
}

// NewBillingCreateServiceOrderV1RequestWithBody generates requests for BillingCreateServiceOrderV1 with any type of body
func NewBillingCreateServiceOrderV1RequestWithBody(server string, contentType string, body io.Reader) (*http.Request, error) {
	var err error
...
func NewReachListContactsV1Request(server string, params *ReachListContactsV1Params) (*http.Request, error) {
	...
	if params != nil {
		...
		if params.SubscriptionStatus != nil {
			...
			if queryFrag, err := runtime.StyleParamWithLocation("form", true, "subscription_status", runtime.ParamLocationQuery, *params.SubscriptionStatus); err != nil {
				return nil, err
			} else if parsed, err := url.ParseQuery(queryFrag); err != nil {
				return nil, err
			} else {
...
func NewVPSDeletePTRRecordV1Request(server string, virtualMachineId VirtualMachineId, ipAddressId IpAddressId) (*http.Request, error) {
	...
	pathParam1, err = runtime.StyleParamWithLocation("simple", false, "ipAddressId", runtime.ParamLocationPath, ipAddressId)
	if err != nil {
		return nil, err
	}
...
type ClientWithResponsesInterface interface {
	...
	// BillingCreateServiceOrderV1WithBodyWithResponse request with any body
	BillingCreateServiceOrderV1WithBodyWithResponse(ctx context.Context, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*BillingCreateServiceOrderV1Response, error)

	BillingCreateServiceOrderV1WithResponse(ctx context.Context, body BillingCreateServiceOrderV1JSONRequestBody, reqEditors ...RequestEditorFn) (*BillingCreateServiceOrderV1Response, error)
...
type BillingCreateServiceOrderV1Response struct {
	Body         []byte
	HTTPResponse *http.Response
...
// Status returns HTTPResponse.Status
func (r BillingCreateServiceOrderV1Response) Status() string {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.Status
	}
	return http.StatusText(0)
...
// StatusCode returns HTTPResponse.StatusCode
func (r BillingCreateServiceOrderV1Response) StatusCode() int {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.StatusCode
	}
	return 0
...
type ReachCreateANewContactV1Response struct {
	Body         []byte
	HTTPResponse *http.Response
	JSON200      *ReachV1ContactsContactResource
	JSON401      *CommonResponseUnauthorizedResponse
	JSON422      *CommonResponseUnprocessableContentResponse
	JSON500      *CommonResponseErrorResponse
}
...
// BillingCreateServiceOrderV1WithBodyWithResponse request with arbitrary body returning *BillingCreateServiceOrderV1Response
func (c *ClientWithResponses) BillingCreateServiceOrderV1WithBodyWithResponse(ctx context.Context, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*BillingCreateServiceOrderV1Response, error) {
	rsp, err := c.BillingCreateServiceOrderV1WithBody(ctx, contentType, body, reqEditors...)
	if err != nil {
		return nil, err
	}
	return ParseBillingCreateServiceOrderV1Response(rsp)
}

func (c *ClientWithResponses) BillingCreateServiceOrderV1WithResponse(ctx context.Context, body BillingCreateServiceOrderV1JSONRequestBody, reqEditors ...RequestEditorFn) (*BillingCreateServiceOrderV1Response, error) {
	rsp, err := c.BillingCreateServiceOrderV1(ctx, body, reqEditors...)
	if err != nil {
		return nil, err
	}
	return ParseBillingCreateServiceOrderV1Response(rsp)
...
// ParseBillingCreateServiceOrderV1Response parses an HTTP response from a BillingCreateServiceOrderV1WithResponse call
func ParseBillingCreateServiceOrderV1Response(rsp *http.Response) (*BillingCreateServiceOrderV1Response, error) {
	bodyBytes, err := io.ReadAll(rsp.Body)
	defer func() { _ = rsp.Body.Close() }()
	if err != nil {
		return nil, err
	...
	response := &BillingCreateServiceOrderV1Response{
		Body:         bodyBytes,
		HTTPResponse: rsp,
	}
...
func ParseReachCreateANewContactV1Response(rsp *http.Response) (*ReachCreateANewContactV1Response, error) {
	...
	switch {
	case strings.Contains(rsp.Header.Get("Content-Type"), "json") && rsp.StatusCode == 200:
		var dest ReachV1ContactsContactResource
		if err := json.Unmarshal(bodyBytes, &dest); err != nil {
			return nil, err
		}
		response.JSON200 = &dest
